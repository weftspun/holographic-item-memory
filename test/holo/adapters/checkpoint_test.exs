...
defmodule Holo.Adapters.CheckpointTest do
  use ExUnit.Case, async: true

  alias Holo.Adapters.NpyCheckpointSink, as: Sink
  alias Holo.Adapters.NpyCheckpointSource, as: Source

  setup do
    dir = Path.join(System.tmp_dir!(), "holo_ckpt_#{System.unique_integer([:positive])}")
