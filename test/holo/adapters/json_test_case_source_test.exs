...
defmodule Holo.Adapters.JsonTestCaseSourceTest do
  use ExUnit.Case, async: true

  alias Holo.Adapters.JsonTestCaseSource, as: Src

  setup do
    path = Path.join(System.tmp_dir!(), "holo_tc_#{System.unique_integer([:positive])}.json")
