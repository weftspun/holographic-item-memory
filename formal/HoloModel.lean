...
theorem itemKey_injective (t0 t1 t2 u0 u1 u2 : Nat)
    (ht0 : t0 < 4096) (ht1 : t1 < 4096) (_ht2 : t2 < 4096)
    (hu0 : u0 < 4096) (hu1 : u1 < 4096) (_hu2 : u2 < 4096)
    (h : itemKey t0 t1 t2 = itemKey u0 u1 u2) :
