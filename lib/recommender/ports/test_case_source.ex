...
defmodule Recommender.Ports.TestCaseSource do
  @moduledoc """
  Driven port (`*_source`): supplies next-item evaluation test cases to the core.

  `Recommender.Core.Eval` computes Hit@k / MRR over a list of `%{"context" => [id], "next_item" => id}`
  ...
  Implemented by: `Recommender.Adapters.JsonTestCaseSource`.
  """
