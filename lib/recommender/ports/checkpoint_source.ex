...
defmodule Recommender.Ports.CheckpointSource do
  @moduledoc """
  Driven port (`*_source`): loads model params into the core for inference/serving.

  The core inference stack (`Recommender.Core.Inference`) consumes a `%{key => Nx.Tensor}` params map
  ...
  Implemented by: `Recommender.Adapters.NpyCheckpointSource`.
  """
