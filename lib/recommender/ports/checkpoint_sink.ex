...
defmodule Recommender.Ports.CheckpointSink do
  @moduledoc """
  Driven port (`*_sink`): writes the core's trained params outward to durable storage.

  Training (`Recommender.Adapters.AxonTrainer`) produces a `%{key => Nx.Tensor}` params map; this port
  ...
  Implemented by: `Recommender.Adapters.NpyCheckpointSink`.
  """
