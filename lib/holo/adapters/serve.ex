...
defmodule Holo.Adapters.Serve do
  @moduledoc """
  ...
  (the shape `Holo.Core.Eval` consumes).

  Ported/retargeted from RecGPT.Adapters.Serve to the residual 4-token contract.
  ...
  defn-ready params map (`Holo.Core.FuxiLinearInferenceParams.build_defn_params/2`)
  ...
  alias Holo.Core.{Decode, Trie, FuxiLinearInference, FuxiLinearInferenceParams}
  alias Holo.Core.FuxiLinearInferenceDefn, as: Defn
