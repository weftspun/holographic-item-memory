...
defmodule Holo.Ports.FsqParamsSource do
  @moduledoc """
  Driven port (`*_source`): supplies FSQ projection params to the core.

  The core (`Holo.Core.FSQ`) needs `project_in`/`project_out` weights to encode item
  ...
  shape `Holo.Core.FSQ.load_params/1` produces.

  Implemented by: `Holo.Adapters.PtFsqParamsSource`.
  """
