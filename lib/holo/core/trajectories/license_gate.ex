...
defmodule Holo.Core.Trajectories.LicenseError do
  @moduledoc "Raised when a trajectory dataset fails the permissive-license gate."
  defexception [:message]
end

defmodule Holo.Core.Trajectories.LicenseGate do
  @moduledoc """
  Hard license gate for RecGPT trajectory training corpora.
  ...
  @manifest_path Application.app_dir(:holographic_item_memory, "priv/trajectories/licenses.json")
  ...
  `Holo.Core.Trajectories.LicenseError`.
