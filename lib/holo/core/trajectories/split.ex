...
defmodule Holo.Core.Trajectories.Split do
  @moduledoc """
  Pure trajectory-splitting domain logic (no file or device I/O).

  Ported from RecGPT.Core.Trajectories.Split. The chronological train/test split
  can be property-tested against in-memory fixtures, independent of dataset
  parsing. The I/O adapter `Holo.Adapters.TrajectoryConvert` reads raw
