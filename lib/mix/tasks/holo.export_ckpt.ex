...
defmodule Mix.Tasks.Holo.ExportCkpt do
  ...
  `Holo.Adapters.NpyCheckpointSource.load_from_export/1` can load. Pure Elixir
  (Unpickler + Unzip) — no Python.

  ## Example

      mix holo.export_ckpt --from-pt data/model.pt --out data/ckpt_export
  ...
  alias Holo.Adapters.{PtCheckpointSource, NpyCheckpointSink}
